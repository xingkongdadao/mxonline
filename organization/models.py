...
class CourseOrg(models.Model):
    ...
    category = models.CharField(default='pxjg', verbose_name='机构类别', max_length=20, choices=(('pxjg', "培训机构"), ('gr',
                                                                                                                '个人'), (
                                                                                             'gx', "高校")))
    ...
    city = models.ForeignKey(CityDict, verbose_name="所在城市", on_delete=models.SET_NULL)
